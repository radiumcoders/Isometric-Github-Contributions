...
export function LeetCodeSearchPanel({
  input,
  loading,
  error,
  onInputChange,
  onSubmit,
}: LeetCodeSearchPanelProps) {
  return (
    <div className="flex flex-col gap-4">
      <div>
        ...
        <p className="mt-1 text-xs leading-relaxed text-emerald-100/65 sm:text-sm">
          Paste a LeetCode username or profile link. Shareable URLs look like
          /leetcode/theorcdev.
        </p>
      </div>
      ...
      <form onSubmit={onSubmit} className="flex flex-col gap-2">
        <Input
          type="text"
          placeholder="leetcoder or https://leetcode.com/u/leetcoder"
          value={input}
